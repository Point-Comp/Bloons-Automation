...
def start_automation():
    ...
    while True:
        try:
            ...
            human_click(765.5, 495.5)
            time.sleep(0.5)
            pyautogui.press(',', presses=2, interval=0.1)
            pyautogui.press('.', presses=5, interval=0.1)
            pyautogui.press(',', presses=2, interval=0.1)
            time.sleep(0.5)
            ...
            # 5. Right of Top Right
            human_click(833.5, 347.0)
            time.sleep(0.5)
            pyautogui.keyDown('h')
            time.sleep(0.15)
            pyautogui.keyUp('h')
            ...
            # 6. Left of Bottom Left
            human_click(528.0, 491.0)
            time.sleep(0.5)
            pyautogui.keyDown('h')
            time.sleep(0.15)
            pyautogui.keyUp('h')
            ...
            # 7. Bottom of Bottom Left
            human_click(608.0, 571.0)
            time.sleep(0.5)
            pyautogui.keyDown('h')
            time.sleep(0.15)
            pyautogui.keyUp('h')
